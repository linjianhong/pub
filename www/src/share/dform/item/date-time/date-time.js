...
!(function (window, angular, undefined) {
  ...
  theModule.component('dformDate', {
    ...
    controller: ['$scope', function ($scope) {
      this.$onChanges = (changes) => {
        ...
        if (changes.str) {
          var str = changes.str.currentValue || "";
      ...
      $scope.onChange = (value) => {
        ...
        $scope.$emit("input.component.valueChange", { value: timeFormat(value, format) });
      }
    }]
  });
  theModule.component('dformTime', {
    bindings: {
      initValue: '<',
      onChange: '&',
      format: '<',
  ...
  theModule.component('dformDatetime', {
    bindings: {
      initValue: '<',
      onChange: '&',
      format: '<',
