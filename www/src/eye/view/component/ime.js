!(function (angular, window, undefined) {
  ...
  theModule.component("imePage", {
    ...
    <div class="flex-1 flex flex-stretch em-12">
      <process-box class="ime-course br-ccc flex" course="v" fire="left" text="上一个" ng-click="D.COURSE.left()"></process-box>
      <div class="ime-middle flex-1 flex-v">
        <process-box class="ime-course br-ccc flex" course="h" fire="up" text="菜单" ng-click="D.COURSE.up()"></process-box>
        ...
        <process-box class="ime-course br-ccc flex" course="h" fire="down" text="确定" ng-click="D.COURSE.down()">
          <div class="flex">
      ...
      <process-box class="ime-course br-ccc flex" course="v" fire="right" text="下一个" ng-click="D.COURSE.right()"></process-box>
    </div>`,
    controller: [
      "$scope",
      "$http",
      ...
      function ($scope, $http, $q, $element, $animateCss, IME, ImeBH, Settings) {
        ...
        $scope.$on("process-box-done", (event, data) => {
          ...
          if (D.COURSE[fire]) D.COURSE[fire]();
        })
