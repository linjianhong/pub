...
!(function (angular, window, undefined) {
  ...
  theModule.component('myApp', {
    template: `
      ...
      <div class="bottom-nav flex flex-arround" ng-if="!footer.hide && !showHome">
      ...
      function ($scope, $http, $q, $rootScope, DjState, $element, $browser, Observable) {
        ...
        if (菜单栏) {
          var userMenu = $scope.menu = [
            { text: "商城首页", i: "home", path: "home" },
            { text: "家具订做", i: "cogs", path: "customize-list" },
        ...
        function reshow() {
          ...
          setTimeout(() => {
            ...
            var showHeader = 标题栏 && !$scope.header.hide;
            var showFooter = 菜单栏 && !$scope.footer.hide;
