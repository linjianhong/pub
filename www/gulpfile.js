...
var configsArray = [
  {
    "name": "商城后台",
    "sub_app_name": "shop-admin",
    "srcPath": srcPath,
    "distPath": "dist/shop-admin",
    "tmpPath": "dist/shop-admin/tmp",
    "jsonPath": "dist/shop-admin/json",
    "outputPath": "dist/shop-admin/output",
    "baseHtmlName": "base-shop-admin.html",
    "debugHtmlName": "index-shop-admin.html",
    "distHtmlName": "index.dist.html",
    "templateJsName": "template-shop-admin.js",
    "injects": [
      [
        srcPath + "/my-lib/**/*.css",
        srcPath + "/share/**/*.css",
        srcPath + "/shop-admin/main/**/*.css",
      ],
      [
        srcPath + "/shop-admin/**/*.css",
        "!" + srcPath + "/shop-admin/main/**/*.css",
      ],
      [
        srcPath + "/shop-admin/**/*.config.js",
      ],
      [
        srcPath + "/my-lib/**/*.module.js",
        srcPath + "/share/**/*.module.js",
        srcPath + "/shop-admin/**/*.module.js",
      ],
      [
        srcPath + "/my-lib/**/*.js",
        srcPath + "/share/**/*.js",
        srcPath + "/shop-admin/**/*.js",
        "!" + srcPath + "/my-lib/**/*.module.js",
        "!" + srcPath + "/share/**/*.module.js",
        "!" + srcPath + "/shop-admin/**/main.js",
        "!" + srcPath + "/shop-admin/**/*.config.js",
        "!" + srcPath + "/shop-admin/**/*.module.js",
      ],
      [
  ...
  {
    "name": "商城前台",
    "sub_app_name": "shop-trade",
    "srcPath": srcPath,
    "distPath": "dist/shop-trade",
    "tmpPath": "dist/shop-trade/tmp",
    "jsonPath": "dist/shop-trade/json",
    "outputPath": "dist/shop-trade/output",
    "baseHtmlName": "base-shop-trade.html",
    "debugHtmlName": "index-shop-trade.html",
    "distHtmlName": "index-shop-trade.dist.html",
    "templateJsName": "template-shop-trade.js",
    "injects": [
      [
        srcPath + "/my-lib/**/*.css",
        srcPath + "/share/**/*.css",
        srcPath + "/shop-trade/main/**/*.css",
      ],
      [
        srcPath + "/shop-trade/**/*.css",
        "!" + srcPath + "/shop-trade/main/**/*.css",
      ],
      [
        srcPath + "/shop-trade/**/*.config.js",
      ],
      [
        srcPath + "/my-lib/**/*.module.js",
        srcPath + "/share/**/*.module.js",
        srcPath + "/shop-trade/**/*.module.js",
      ],
      [
        srcPath + "/my-lib/**/*.js",
        srcPath + "/share/**/*.js",
        srcPath + "/shop-trade/**/*.js",
        "!" + srcPath + "/my-lib/**/*.module.js",
        "!" + srcPath + "/share/**/*.module.js",
        "!" + srcPath + "/shop-trade/**/main.js",
        "!" + srcPath + "/shop-trade/**/*.config.js",
        "!" + srcPath + "/shop-trade/**/*.module.js",
      ],
      [
...
gulp.task("clean-shop-admin", function () { gulp_clean([configsArray[0]]); });
gulp.task("clean-shops", function () { gulp_clean([configsArray[1]]); });
gulp.task("clean-material", function () { gulp_clean([configsArray[2]]); });
