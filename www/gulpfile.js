...
var configsArray = [
  {
    "name": "打字",
    "sub_app_name": app_name[0],
    "srcPath": srcPath,
    "distPath": `dist/${app_name[0]}`,
    "tmpPath": `dist/${app_name[0]}/tmp`,
    "jsonPath": `dist/${app_name[0]}/json`,
    "outputPath": `dist/${app_name[0]}/output`,
    "baseHtmlName": `base-${app_name[0]}.html`,
    "debugHtmlName": `index-${app_name[0]}.html`,
    "distHtmlName": "index.dist.html",
    "templateJsName": `template-${app_name[0]}.js`,
    "injects": [
      [
        srcPath + "/my-lib/**/*.css",
        srcPath + "/share/**/*.css",
        srcPath + `/${app_name[0]}/main/**/*.css`,
      ],
      [
        srcPath + `/${app_name[0]}/**/*.css`,
        "!" + srcPath + `/${app_name[0]}/main/**/*.css`,
      ],
      [
        srcPath + `/${app_name[0]}/**/*.config.js`,
      ],
      [
        srcPath + "/my-lib/**/*.module.js",
        srcPath + "/share/**/*.module.js",
        srcPath + `/${app_name[0]}/**/*.module.js`,
      ],
      [
        srcPath + "/my-lib/**/*.js",
        srcPath + "/share/**/*.js",
        srcPath + `/${app_name[0]}/**/*.js`,
        "!" + srcPath + "/my-lib/**/*.module.js",
        "!" + srcPath + "/share/**/*.module.js",
        "!" + srcPath + `/${app_name[0]}/**/main.js`,
        "!" + srcPath + `/${app_name[0]}/**/*.config.js`,
        "!" + srcPath + `/${app_name[0]}/**/*.module.js`,
      ],
      [
...
gulp.task(`clean-${app_name[0]}`, function () { gulp_clean([configsArray[0]]); });
